                            ...
                            <form id="live-capture-form" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="Neon Neon-theme-dragdropbox">                               
                                    ...
                                    <div class="d-grid gap-2">
                                        <button type="submit"  id="btn-proceed-photo" class="btn btn-primary fs-16">Proceed Photo</button>
                                        <a onClick="capturePhoto()" id="btn-capture-photo" class="btn btn-dark text-white fs-16">Capture Photo</a>
                                        <a onClick="startCamera()" id="btn-start-camera" class="btn btn-dark text-white fs-16">Start Camera</a>
                                    </div>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="card-body border-bottom py-3">
                            <p class="text-secondary">Face detection analysis and statistic</p>
                             <div class="text-center p-l-20 p-t-20 p-b-20 p-r-20">
                                ...
                                <h3 id="result-info">Capture and images to see detection results</h3>
